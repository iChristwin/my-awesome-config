...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mylayoutbox = wibox.container.margin(s.mylayoutbox, 5, 5, 5)
    ...
    s.mywibox = awful.wibar({
        position = "right", screen = s, width = 45, bg = beautiful.bg_normal .. "55",
        shape = function(cr, width, height) gears.shape.rounded_rect(cr, width, height, RADIUS) end,
        border_width = 10,
    })
...
globalkeys = gears.table.join(
    ...
    -- my key binds
    -- Rofi
    awful.key({ },            "F1",     function () awful.util.spawn("rofi -show drun -show-icons") end,
              {description = "run rofi to launch apps", group = "launcher"}),
